...
If you are an author, please make sure to send us your final version (.doc or .docx format) and a signed copyright form via email to info@icsta.net. You can find the copyright form here: https://icsta.net/papers/. Please note that failing to do so may result in an unsuccessful process of your registration.
...
We are pleased to announce that the ICSTA 2019 be held at the Hotel Real Palácio. Additionally, we have collaborated with the hotel to offer our attendees a reduced 
rate on their accommodations! This discounted rate is only valid until May 12, 2019. Please view the booking form here: https://icsta.net/RealPalacioLisbonBookingForm.pdf
...
$your_subject = "Your Registration Details for ICSTA'19";

$your_headers = "From: ICSTA'19 <" . $my_email . ">";
...
<title>ICSTA'19 - Registration Form Filled!</title>
...
<footer id="contact">
  ...
  <div class="unit-spacer">
  <p class="body">For questions or comments regarding ICSTA'19, please fill out the form below:</p>
